...
const REMOTE_LAND_MINE_SCENE = preload("res://spells/scenes/remote_land_mine_scene.tscn")
...
func _place_remote_land_mine(executor_peer_id: int):
	...
	player.spell_nodes.add_child(current_remote_land_mine_scene)
...
func _explode_remote_land_mine():
	...
	sprite.texture = preload("res://spells/textures/shitty_remote_land_mine_explosion_texture.png")
